...
<form class="form-horizontal" nama="f1" method="POST" action="p_form.php">
...
<div class="form-group">
  ...
  <div class="col-md-8">
    <div class="input-group">
      ...
      <input id="prependedtext" name="prependedtext" class="form-control" placeholder="input your name" type="text" required="">
    </div>
...
<div class="form-group">
  ...
  <div class="col-md-8">
  <input id="textinput" name="textinput" type="text" placeholder="Umur" class="form-control input-md" required="">
